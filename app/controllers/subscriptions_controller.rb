class SubscriptionsController < ApplicationController
  ...
  private
    ...
    def set_subscription
      ...
      #We need the current user id here so we make sure someone other than who the subscription belongs to can't do anything to it.
    end

    # Only allow a list of trusted parameters through.
    def subscription_params
      params.require(:subscription).permit(:forum_id, :user_id, :priority)
      #params is an object that exists in rails whenever a request is made
    end
end
